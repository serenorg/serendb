...
import pytest
from fixtures.serendb_fixtures import SerenDBAuthBroker
from jwcrypto import jwk, jwt


@pytest.mark.asyncio
async def test_auth_broker_happy(
    static_auth_broker: SerenDBAuthBroker,
    ...
    token = jwt.JWT(
        header={"kid": serendb_authorize_jwk.key_id, "alg": "RS256"}, claims={"sub": "user1"}
    )
    ...
    assert "anonymous" in res["headers"]["serendb-connection-string"], (
