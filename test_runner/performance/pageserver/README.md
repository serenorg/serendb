...
2. Mount the Instance Store => `serendb.git/scripts/ps_ec2_setup_instance_store`
...
```
RUST_BACKTRACE=1 SERENDB_ENV_BUILDER_USE_OVERLAYFS_FOR_SNAPSHOTS=1 DEFAULT_PG_VERSION=17 BUILD_TYPE=release \
