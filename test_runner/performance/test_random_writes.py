...
def test_random_writes(serendb_with_baseline: PgCompare):
    ...
    # increasing n_rows doesn't have impact on the (serendb_runtime / vanilla_runtime)
    # performance ratio.
    ...
    with closing(env.pg.connect()) as conn:
        with conn.cursor() as cur:
            ...
            # Avoiding segment collisions maximizes (serendb_runtime / vanilla_runtime).
