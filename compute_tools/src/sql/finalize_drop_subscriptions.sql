...
BEGIN
    IF NOT EXISTS(
        ...
        AND schemaname OPERATOR(pg_catalog.=) 'serendb'::pg_catalog.name
    )
    THEN
        CREATE TABLE serendb.drop_subscriptions_done
    ...
    INSERT INTO serendb.drop_subscriptions_done VALUES (1, pg_catalog.current_setting('serendb.timeline_id'))
    ON CONFLICT (id) DO UPDATE
    SET timeline_id = pg_catalog.current_setting('serendb.timeline_id')::pg_catalog.text;
END
$$
