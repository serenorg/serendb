...
The configuration in this directory is used for testing SerenDB docker images: it is
not intended for deploying a usable system. To run a development environment where
you can experiment with a miniature SerenDB system, use `cargo serendb` rather than container images.
