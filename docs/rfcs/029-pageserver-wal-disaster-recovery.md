...
The proposed changes for the various components of the SerenDB architecture
are written up in this notion page:

https://www.notion.so/serendb/Pageserver-disaster-recovery-one-pager-4ecfb5df16ce4f6bbfc3817ed1a6cbb2
