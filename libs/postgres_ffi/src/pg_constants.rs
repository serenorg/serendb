...
// from serendb_rmgr.h
pub const RM_SERENDB_ID: u8 = 134;

pub const XLOG_SERENDB_HEAP_INIT_PAGE: u8 = 0x80;

pub const XLOG_SERENDB_HEAP_INSERT: u8 = 0x00;
pub const XLOG_SERENDB_HEAP_DELETE: u8 = 0x10;
pub const XLOG_SERENDB_HEAP_UPDATE: u8 = 0x20;
pub const XLOG_SERENDB_HEAP_HOT_UPDATE: u8 = 0x30;
pub const XLOG_SERENDB_HEAP_LOCK: u8 = 0x40;
pub const XLOG_SERENDB_HEAP_MULTI_INSERT: u8 = 0x50;

pub const XLOG_SERENDB_HEAP_VISIBLE: u8 = 0x40;
