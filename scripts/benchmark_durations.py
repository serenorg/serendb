...
FALLBACK_DURATION = {
    ...
    "test_runner/performance/test_bulk_insert.py::test_bulk_insert[serendb]": 18.275,
    ...
    "test_runner/performance/test_compare_pg_stats.py::test_compare_pg_stats_ro_with_pgbench_select_only[serendb-5-10-100]": 11.68,
    ...
    "test_runner/performance/test_compare_pg_stats.py::test_compare_pg_stats_rw_with_pgbench_default[serendb-5-10-100]": 11.315,
    "test_runner/performance/test_compare_pg_stats.py::test_compare_pg_stats_rw_with_pgbench_default[vanilla-5-10-100]": 18.783,
    "test_runner/performance/test_compare_pg_stats.py::test_compare_pg_stats_wal_with_pgbench_default[serendb-5-10-100]": 11.647,
    "test_runner/performance/test_compare_pg_stats.py::test_compare_pg_stats_wal_with_pgbench_default[vanilla-5-10-100]": 17.04,
    "test_runner/performance/test_compare_pg_stats.py::test_compare_pg_stats_wo_with_heavy_write[serendb-10-1]": 11.01,
    "test_runner/performance/test_compare_pg_stats.py::test_compare_pg_stats_wo_with_heavy_write[serendb-10-10]": 11.902,
    ...
    "test_runner/performance/test_compare_pg_stats.py::test_compare_pg_stats_wo_with_pgbench_simple_update[serendb-5-10-100]": 11.33,
    ...
    "test_runner/performance/test_copy.py::test_copy[serendb]": 13.817,
    ...
    "test_runner/performance/test_gist_build.py::test_gist_buffering_build[serendb]": 14.868,
    "test_runner/performance/test_gist_build.py::test_gist_buffering_build[vanilla]": 14.393,
    "test_runner/performance/test_latency.py::test_measure_read_latency_heavy_write_workload[serendb-1]": 20.588,
    ...
    "test_runner/performance/test_parallel_copy_to.py::test_parallel_copy_different_tables[serendb]": 35.552,
    "test_runner/performance/test_parallel_copy_to.py::test_parallel_copy_different_tables[vanilla]": 66.762,
    "test_runner/performance/test_parallel_copy_to.py::test_parallel_copy_same_table[serendb]": 85.177,
    "test_runner/performance/test_parallel_copy_to.py::test_parallel_copy_same_table[vanilla]": 92.12,
    "test_runner/performance/test_perf_pgbench.py::test_pgbench[serendb-45-10]": 107.009,
    "test_runner/performance/test_perf_pgbench.py::test_pgbench[vanilla-45-10]": 99.582,
    "test_runner/performance/test_random_writes.py::test_random_writes[serendb]": 4.737,
    "test_runner/performance/test_random_writes.py::test_random_writes[vanilla]": 2.686,
    "test_runner/performance/test_seqscans.py::test_seqscans[serendb-100000-100-0]": 3.271,
    "test_runner/performance/test_seqscans.py::test_seqscans[serendb-10000000-1-0]": 50.719,
    "test_runner/performance/test_seqscans.py::test_seqscans[serendb-10000000-1-4]": 15.992,
    ...
    "test_runner/performance/test_wal_backpressure.py::test_heavy_write_workload[serendb_off-10-5-5]": 194.841,
    "test_runner/performance/test_wal_backpressure.py::test_heavy_write_workload[serendb_on-10-5-5]": 286.667,
    "test_runner/performance/test_wal_backpressure.py::test_heavy_write_workload[vanilla-10-5-5]": 85.577,
    "test_runner/performance/test_wal_backpressure.py::test_pgbench_intensive_init_workload[serendb_off-1000]": 297.626,
    "test_runner/performance/test_wal_backpressure.py::test_pgbench_intensive_init_workload[serendb_on-1000]": 646.187,
    "test_runner/performance/test_wal_backpressure.py::test_pgbench_intensive_init_workload[vanilla-1000]": 989.776,
    "test_runner/performance/test_wal_backpressure.py::test_pgbench_simple_update_workload[serendb_off-45-100]": 125.638,
    "test_runner/performance/test_wal_backpressure.py::test_pgbench_simple_update_workload[serendb_on-45-100]": 123.554,
    "test_runner/performance/test_wal_backpressure.py::test_pgbench_simple_update_workload[vanilla-45-100]": 190.083,
    "test_runner/performance/test_write_amplification.py::test_write_amplification[serendb]": 21.016,
