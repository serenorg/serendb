...
echo "Uploading perf report to SerenDB pg"
# ingest per test results data into SerenDB backed postgres running in staging to build grafana reports on that data
